...
from scdata.matrix._index import AxisSpec, normalize_axis, normalize_key, rust_payload
from scdata.exceptions import _call_core, _invalid_argument
from scdata.compress.limits import DEFAULT_N_WORKERS
...
class ScCsr:
    ...
    def to_scipy(self) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "ScCsr.to_scipy() requires scipy; install scdata-toolkit[scipy]"
            ) from exc
