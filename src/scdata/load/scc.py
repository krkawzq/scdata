...
Path / ZIP discovery follows :mod:`scdata.compress` (``open_store`` / ``zip.list_stores`` /
...
from scdata.exceptions import Error, InvalidArgumentError
from scdata.compress.zip import META_NAME, list_stores, normalize_prefix
