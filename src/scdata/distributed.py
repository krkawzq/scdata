...
from scdata._validation import as_int, dtype_from_core
...
from scdata.stats import SessionState

if TYPE_CHECKING:
    from scdata.plan import Plan
    ...
    def __init__(
        ...
        *,
        ...
        self._thread = threading.Thread(
            ...
            name="scdata-distributed-producer",
            daemon=False,
        )
...
def distributed_prefetch(
    ...
    *,
    ...
    from scdata.plan import compile
