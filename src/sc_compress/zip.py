...
from sc_compress._validate import ensure_path
from sc_compress.exceptions import PerformanceWarning, _invalid_argument
from sc_compress.write_options import WriteOptions
...
def write_dense(
    ...
    *,
    ...
    from sc_compress.io import write_dense as write_dense_matrix
...
def write_csr(
    ...
    *,
    ...
    from sc_compress.io import write_csr as write_csr_matrix
...
def write_csr_arrays(
    ...
    *,
    ...
    from sc_compress.io import write_csr_arrays as write_csr_buffers
