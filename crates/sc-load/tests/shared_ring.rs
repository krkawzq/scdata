...
fn dense_plan() -> (tempfile::TempDir, sc_load::Plan, Vec<Vec<u32>>) {
    dense_plan_with_rows(6)
}

fn dense_plan_with_rows(n_rows: usize) -> (tempfile::TempDir, sc_load::Plan, Vec<Vec<u32>>) {
...
fn dense_plan_with_prefetch(
    n_rows: usize,
    prefetch_step: usize,
) -> (tempfile::TempDir, sc_load::Plan, Vec<Vec<u32>>) {
...
fn rows_from_batch(batch: &sc_load::SharedBatch) -> Vec<Vec<u32>> {
