# sc-load Python binding

The public API lives in `src/sc_load`. This crate exposes only the private
`sc_load._core` PyO3 handles used to open datasets, compile immutable plans, and
